<?php
	$bc_args = array('wrap_before'=>'<div class="breadcrumb-div"><div class="breadcrumb">','wrap_after'=>'</div></div>');
?>

<section class="archive-info">
	<div class="row">
		<div class="col-sm-6 col-md-4">
			<?php woocommerce_breadcrumb($bc_args); ?>
		</div>
		<div class="col-sm-6 col-md-4">
			<div class="results-count text-center">
				<span class="results-count__title">
				<?php
