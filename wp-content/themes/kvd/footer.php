	  	...
	  	<div class="main">
	   		...
	   		<div class="footer-bottom cf">
	    		...
	    		<div class="footer-col3 footer-bottom-link"> 
	    			<a href="<?php echo get_page_link($footer_link1); ?>" title="<?php echo $footer_text1; ?>"><?php echo $footer_text1; ?></a> &nbsp;|&nbsp; <a target="_blank" href="<?php echo $footer_link2; ?>" title="<?php echo $footer_text2; ?>"><?php echo $footer_text2; ?></a> 
	    		</div>
