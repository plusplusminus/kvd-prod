...
var project 		= 'kvd', // Project name, used for build zip.
	url 		= 'localhost/kvd', // Local Development URL for BrowserSync. Change as-needed.
...
gulp.task('vendorsJs', function() {
	return 	gulp.src(['./assets/js/vendor/*.js', bower+'/tether/dist/js/tether.js',bower+'/bootstrap/dist/js/bootstrap.js',bower+'/bxslider-4/dist/jquery.bxslider.js'])
