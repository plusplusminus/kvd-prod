...
class WC_Wishlists_Settings_Admin {
	...
	function init_form_fields() {
		...
		$this->fields['wc_wishlists_main'] = apply_filters( 'woocommerce_wishlists_options_settings_fields', array(
			...
			'desc' => __('If set to automatic, a list with a generic title will be used.  If set to no, guests and users will be required to fill out a brief form and give the list a name before it will be created.', 'wc_wishlist'),
