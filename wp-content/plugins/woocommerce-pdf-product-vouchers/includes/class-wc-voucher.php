			...
			switch ( $field_name ) {
				...
				case 'product_name':
					...
					if ( apply_filters( 'wc_pdf_product_vouchers_product_name_multi_line', false, $this ) ) {
						$this->textarea_field( $fpdf, 'product_name', $this->get_product_name(), $show_border, isset( $field['text_align'] ) && $field['text_align'] ? $field['text_align'] : $this->voucher_text_align );
					} else {
						$this->text_field( $fpdf, 'product_name', $this->get_product_name(), $show_border, isset( $field['text_align'] ) && $field['text_align'] ? $field['text_align'] : $this->voucher_text_align );
					}
				break;
				...
				default:
					...
					if ( isset( $field['multiline'] ) && $field['multiline'] ) {
						$this->textarea_field( $fpdf, $field_name, apply_filters( 'wc_pdf_product_vouchers_voucher_field_value', $this->$field_name, $this, $field_name, $field ), $show_border, isset( $field['text_align'] ) ? $field['text_align'] : $this->voucher_text_align );
					} else {
						$this->text_field( $fpdf, $field_name, apply_filters( 'wc_pdf_product_vouchers_voucher_field_value', $this->$field_name, $this, $field_name, $field ), $show_border, isset( $field['text_align'] ) ? $field['text_align'] : $this->voucher_text_align );
					}
				break;
			}
		}
